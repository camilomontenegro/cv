    ...
    this.data = [
      {
        ...
        description: 'Skills to take the lead of any software or technologic project, with abilities to organize work teams, mostly, software teams, improving their stimations, and resources management.',
      ...
      },
      {
        ...
        icon: require('./../assets/img/book.png'),
        description: 'With this training, I learned how to command a software developer team better than before, and how to keep analytical eye on every task, every issue, without bothering every engineer on my charge. Actually, I confirmed that some of my habits about dealing with developers match with the rules of Agile methodologies.',
        imageUrl: require('./../assets/img/education.png')
      },
      {
        time: '2006',
        ...
        icon: require('./../assets/img/graduate.png'),
        description: 'According to my alma mater, I got the skills to optimize process, and improve the resources management of any kind of project, and even know some of networks infrastructure. But, I have been focusing my career on the software industry, making a lot of projects in many areas, from desktop applications, including videogames, social applications, and ending with mobile applications, and those lasts ones are my favorites, because, you know, I love coding!.',
        imageUrl: require('./../assets/img/unillanos.png')
      },
    ];
